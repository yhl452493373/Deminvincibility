    ...
    internal class UpdateWeightLimitsPatch : ModulePatch
    {
...
#endif
        {
            ...
            if (!bool_7 && iobserverToPlayerBridge_0.iPlayer.IsYourPlayer)
            {
                ...
                Vector3 vector2 =
                    new Vector3(
                        inertia.InertiaLimitsStep * (float)iobserverToPlayerBridge_0.Skills.Strength.SummaryLevel,
                        inertia.InertiaLimitsStep * (float)iobserverToPlayerBridge_0.Skills.Strength.SummaryLevel, 0f);
